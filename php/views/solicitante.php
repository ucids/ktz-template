...
<div id="kt_app_content" class="app-content  flex-column-fluid ">
            ...
            <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                ...
                <li class="nav-item mt-2">
                    <a class="nav-link text-active-primary ms-0 me-10 py-5 <? if($section == 'lista_solicitudes'){
                            echo 'active';}?>"
                        href="index.php?section=lista_solicitudes">
                        Statements </a>
                </li>
                <!--end::Nav item-->
                <!--begin::Nav item-->
                <li class="nav-item mt-2">
                    <a class="nav-link text-active-primary ms-0 me-10 py-5 <? if($tipo == 'po'){
                            echo 'active';}?>"
                        href="index.php?section=nueva_solicitud&tipo=po">
                        Solicitud PO </a>
                </li>
                <!--end::Nav item-->
                <!--begin::Nav item-->
                <li class="nav-item mt-2">
                    <a class="nav-link text-active-primary ms-0 me-10 py-5 <? if($tipo == 'tj'){
                            echo 'active';}?>"
                        href="index.php?section=nueva_solicitud&tipo=tj">
                        Solicitud TJ </a>
                </li>
                <!--end::Nav item-->
                <!--begin::Nav item-->
    ...
    <? 
    $section = isset($_GET['section']) ? $_GET['section'] : 'default';
    include 'solicitante/'. $section .'.php'?>
    <!--end::Statements-->
</div>-