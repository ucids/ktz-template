        ...
        <div class="card pt-4 mb-6 mb-xl-9">
            ...
            <div class="card-header border-0">
                ...
                <div class="card-title">
                    <h2 class="fw-bold mb-0">Solicitud # <?= $solicitud['id'];?></h2>
                </div>
                <!--end::Card title-->
            </div>
            <!--end::Card-->
                            ...
                            <div class="card-body pt-0">
                                <div class="fw-bold fs-2">
                                    <div class="d-flex">
                                        ...
                                        <div class="ms-2">
                                            <? echo '$93939' ?> <span
                                                class="text-muted fs-4 fw-semibold">Disponibles</span>
                                        </div>
                                    </div>
                                    <div class="fs-7 fw-normal text-muted">Earn reward points with every
                                        purchase.</div>
                        ...
                        <div class="card-body pt-0">
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0">
                                    <thead>
                                        <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                                            ...
                                            <th class="min-w-200px text-begin">Cantidad</th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <div class="input-group w-md-150px" data-kt-dialer="true"
                                                    data-kt-dialer-currency="true" data-kt-dialer-min="1"
                                                    ...
                                                    <input type="text" class="form-control" readonly
                                                        placeholder="Amount" value="<?= $articulo['cantidad']?>"
                            ...
                            <div class="text-end ms-2">
                                <a href="#" id="rejectButton"
                                    ...
                                    data-solicitud-id="<?php echo $solicitudId; ?>" data-action="rechazar">Rechazar</a>

                                <a href="#" id="approveButton"
                                    class="btn btn-outline btn-outline-dashed btn-outline-success btn-active-light-success fs-3 ms-7"
                                    data-solicitud-id="<?php echo $solicitudId; ?>" data-action="aprobar">Aprobar</a>
                            </div>
                            <? } else { ?>
                            <!--begin::Alert-->
                            <div
                                class="alert alert-dismissible bg-light-<?= $color; ?> border border-<?= $color; ?> d-flex flex-column flex-sm-row p-5 mb-10">
                                <!--begin::Icon-->
                                <i class="ki-duotone ki-search-list fs-2hx text-<?= $color; ?> me-4 mb-5 mb-sm-0"><span
                                ...
                                <div class="d-flex flex-column pe-0 pe-sm-10">
                                    <!--begin::Title-->
                                    <h5 class="mb-1">Solicitud # <?= $solicitudId?></h5>
                                    <!--end::Title-->
                                ...
                                <button type="button"
                                    ...
                                    <i class="ki-duotone ki-cross fs-1 text-<?= $color; ?>"><span
...
$(document).ready(function() {
    $('#rejectButton, #approveButton').click(function(e) {
        e.preventDefault();
