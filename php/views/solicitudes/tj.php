    ...
    <div class="d-flex flex-column flex-lg-row">
        ...
        <div class="flex-lg-row-fluid me-lg-15 order-2 order-lg-1 mb-10 mb-lg-0">
            ...
            <form class="form" method="post" action="functions/solicitud/guardar_solicitud.php" id="solicitud">
                <!--begin::Type-->
                <input type="hidden" name="tipo" value="tj">
                ...
                <div class="card card-flush pt-3 mb-5 mb-lg-10">
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-title">
                            <h2 class="fw-bold">Solicitud TJ</h2>
                        </div>
                        <!--begin::Card title-->
                    </div>
                    <!--end::Card header-->
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="d-flex align-items-center p-3 mb-8">
                            <span class="input-group-text" id="basic-addon1">Shipping Adress</span>
                            <input type="text" class="form-control" name ="address"placeholder="Shipping Address" aria-label="Shipping Address" aria-describedby="basic-addon1"/>
                        </div>
                        <!--begin::Notice-->
                ...
                <div class="card card-flush pt-3 mb-5 mb-lg-10">
                    ...
                    <div class="card-header">
                        <!--begin::Card title-->
                        <div class="card-title">
                            <h2 class="fw-bold">Artic   ulos</h2>
                        </div>
                        <!--begin::Card title-->
                    </div>
                    <!--end::Card header-->
                ...
                <div class="card card-flush pt-3 mb-5 mb-lg-10">
                    ...
                    <div class="card-header">
                        <!--begin::Card title-->
                        <div class="card-title">
                            <h2 class="fw-bold">Detalles de la Solicitud</h2>
                        </div>
                        <!--begin::Card title-->
                    </div>
                    <!--end::Card header-->
                ...
                <div class="card-body pt-0 fs-6">
                    ...
                    <div class="mb-7">
                        ...
                        <div class="mb-0">
                            ...
                            <!--begin::Price-->
                            <span class="fw-semibold text-gray-600"><span class="total "><span class="total-value"></span> USD</span>
                            <!--end::Price-->
                        </div>
                        <!--end::Details-->
                    </div>
